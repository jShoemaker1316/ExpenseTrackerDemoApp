...
struct Transaction: Identifiable, Decodable, Hashable {
    ...
    var isExpense: Bool
    var isEdited: Bool
//element id equal to category id needs to be if let to avoid error.
...
extension Category {
    static let autoAndTransportation = Category(id: 1, name: "Auto & Transportation", icon: .car_alt)
...
//sub categories
    ...
    static let restuarants = Category(id: 502, name: "Restaurants", icon: .utensils, mainCategoryID: 5)
    ...
    static let creditCardPayment = Category(id: 901, name: "Credit Care Payment", icon: .exchange_alt, mainCategoryID: 9)
}
